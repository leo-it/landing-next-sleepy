    ...
    <>
      ...
      >
        ...
        <Box sx={{ display: "flex" }}>
          ...
          <Box sx={{ mr: { md: "50px" }, my: "auto" }}>
            <h4 className="inactive"> <Fade >Blog</Fade></h4>
          </Box>
          <Box sx={{ mr: "50px", my: "auto", width: "140px" }}>
            <h4 className="inactive"><Fade >Top articles</Fade></h4>
          </Box>
          <Box sx={{ mr: { md: "50px" }, my: "auto" }}>
            <h4 className="inactive"><Fade >Careers</Fade></h4>
          </Box>
        </Box>
      </Box>
    </>
